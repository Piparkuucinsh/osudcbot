...
function extractStats(osuUser: any): Array<{ name: string; value: string }> {
    const statistics = [
        ...
        {
            name: 'accuracy',
            value: osuUser.statistics.hit_accuracy?.toString() || 'N/A',
        },
        {
            name: 'play_count',
            value: osuUser.statistics.play_count?.toString() || 'N/A',
        },
        {
            name: 'total_score',
            value: osuUser.statistics.total_score?.toString() || 'N/A',
        },
        {
            name: 'ranked_score',
            value: osuUser.statistics.ranked_score?.toString() || 'N/A',
        },
        {
            name: 'level',
            value: osuUser.statistics.level.current?.toString() || 'N/A',
        },
        {
            name: 'global_rank',
            value: osuUser.statistics.global_rank?.toString() || 'N/A',
        },
        {
            name: 'country_rank',
            value: osuUser.statistics.country_rank?.toString() || 'N/A',
        },
        {
            name: 'highest_rank',
            value: osuUser.rank_highest?.rank?.toString() || 'N/A',
        },
    ]
    return statistics
}
