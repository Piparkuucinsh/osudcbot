    ...
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption((option) =>
            option
                .setName('days_limit')
                .setDescription(
                    'The number of days to limit the achievement to - default 7'
                )
                .setRequired(false)
        ),
        ...
        try {
            ...
            if (result_replied) {
                await interaction.editReply({
                    content: `Processing achievements...`,
                    components: [],
                })
            } else {
            ...
            if (result_replied) {
                await interaction.editReply({
                    content: `${mentions}Top achievement of the week`,
